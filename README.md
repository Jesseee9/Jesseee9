...
- **Automation:** Python automation — provisioning, offboarding, bulk operations, audit logging
...
- Looks up users, checks licenses, and disables accounts in Microsoft Entra ID via Graph API
...
![ServiceNow](https://img.shields.io/badge/ServiceNow-293E40?style=for-the-badge&logo=servicenow&logoColor=29B6F6)
...
| **Operating Systems** | Linux (SSH, systemctl, user management, log review), Windows 10/11 |
